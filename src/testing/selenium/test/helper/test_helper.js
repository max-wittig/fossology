...
module.exports =
{
    ...
    uploadFile : function(uploadSettings)
    {
        ...
        if(uploadSettings.description != undefined) {element(by.name('descriptionInputName')).sendKeys(uploadSettings.description);}
        ...
        if(uploadSettings.agentSettings != undefined)
        {
            ...
            if(agentSettings.copyright_email_author){ element(by.name("Check_agent_copyright")).click();}
            if(agentSettings.ecc){ element(by.name("Check_agent_ecc")).click();}
            if(agentSettings.mime){ element(by.name("Check_agent_mimetype")).click();}
            if(agentSettings.monk){ element(by.name("Check_agent_monk")).click();}
            if(agentSettings.nomos){ element(by.name("Check_agent_nomos")).click();}
            if(agentSettings.packages){ element(by.name("Check_agent_pkgagent")).click();}
        }

        if(uploadSettings.licenseDeciderSettings != undefined)
        {
            let licenseDeciderSettings = uploadSettings.licenseDeciderSettings;
            if(licenseDeciderSettings.nomosInMonk){ element(by.css("input[value='nomosInMonk']")).click();}
            if(licenseDeciderSettings.reuseBulk){ element(by.css("input[value='reuseBulk']")).click();}
            if(licenseDeciderSettings.wipScannerUpdates){ element(by.css("input[value='wipScannerUpdates']")).click();}
        }
